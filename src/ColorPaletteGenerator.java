...
public class ColorPaletteGenerator {
    ...
    public static void main(String[] args) {
        ...
        out.println(
                "Would you like to generate a new color palette? Enter Y to continue: ");
        while (in.nextLine().equals("Y")) {
            ...
            ColorModel randomColor = new ColorModel1(red, green, blue);

            int intensity = Math.min(255 - randomColor.getGreen(),
                    255 - randomColor.getBlue());

            Sequence<ColorModel> palette = randomColor.monochromatic(0,
                    intensity);
